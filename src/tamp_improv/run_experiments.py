...
def run_cleanup_table_multi_seed_experiment(
    system_cls: type,
    use_context_wrapper: bool,
    seeds: list[int],
    episodes_per_scenario: int,
...
def run_cleanup_table_experiment(episodes_per_scenario: int):
    """Run the CleanupTable experiment with multiple seeds."""
    print("\n=== Running CleanupTable Multi-Policy RL Experiment ===")
    print(f"Episodes per scenario: {episodes_per_scenario}")

    results = run_cleanup_table_multi_seed_experiment(
